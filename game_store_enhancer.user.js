...
(function () {
    ...
    function scanPage() {
        ...
        // v2.6.0: Specific Dispatcher for Humble Bundle
        if (currentConfig.name === 'Humble Bundle') {
            scanHumbleBundle();
            return;
        }
        ...
        // v2.4.1: Auto Age Check (Generic / Other Sites)
        // Humble handles this in scanHumbleGeneric now, but Fanatical might need it? 
        // Actually the age check logic was specific to Humble in the original code. 
        // Let's keep it here for safety or move it to site specific config later. 
        // For now, scanHumbleGeneric handles it for Humble.
    }


    // Observer and other init code follows...
